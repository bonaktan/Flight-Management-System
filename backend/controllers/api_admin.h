...
class admin : public drogon::HttpController<admin> {
   public:
    ...
    METHOD_ADD(admin::delete_airplane, "/airplane/delete/{id}", Delete, "AuthFilter");
    METHOD_ADD(admin::delete_airport, "/airport/delete/{id}", Delete, "AuthFilter");
    METHOD_ADD(admin::delete_account, "/account/delete/{id}", Delete, "AuthFilter");
    METHOD_ADD(admin::delete_staff, "/staff/delete/{id}", Delete, "AuthFilter");
    METHOD_ADD(admin::delete_flight, "/flight/delete/{id}", Delete, "AuthFilter");
    METHOD_LIST_END
